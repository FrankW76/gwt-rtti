...
public class EnumTestObject extends Persistent
{
	public enum Fruit
	{
		APPLE,
	...
	public TestEnum aEnum = TestEnum.ONE;
	public Fruit nestedEnum = Fruit.APPLE;
	
	Object[] get()
	{
		Object[] res = {Fruit.APPLE, Fruit.BANANA}; 
		return res; 
	}
}
